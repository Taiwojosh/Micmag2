...
function DropdownPanel({
  ...
  return (
    ...
    >
      {/* Top accent bar */}
      <div className="h-[3px] w-full bg-gradient-to-r from-[#d32f2f] via-[#b45309] to-[#000082]" />
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-[0.18] z-0" style={{ borderRadius: '18px' }}>
          ...
          <motion.div
            ...
            className="absolute -bottom-16 left-1/2 w-44 h-44 rounded-full bg-[#1e3a5f] filter blur-[45px]"
          />
          <motion.div
            animate={{ x: [-20, 15, -10, -20], y: [5, -12, 10, 5], scale: [0.9, 1.1, 0.95, 0.9] }}
            transition={{ duration: 16, repeat: Infinity, ease: 'easeInOut' }}
            className="absolute top-0 right-[20%] w-36 h-36 rounded-full bg-[#1a6b3c] filter blur-[35px]"
          />
        </div>
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <Link to="/" className="flex items-center gap-2.5 group flex-shrink-0">
            ...
            <div className="flex flex-col text-left">
              <span className="text-[23px] font-serif font-black tracking-[0.14em] uppercase leading-none" style={{ color: '#000082' }}>MICMAG</span>
              ...
              <li key={link.name} className="relative h-full flex items-center">
                <div className="relative group/link py-1 flex items-center">
                  <Link
                    ...
                    className="text-[11px] xl:text-[0.79rem] font-bold tracking-[0.12em] uppercase transition-colors duration-300"
                    style={{ color: '#000082' }}
                  >
                    {link.name}
                  </Link>
          ...
          <div className="hidden lg:flex items-center gap-3">
            <a
              ...
              className="flex items-center gap-1.5 text-[11px] font-bold uppercase text-[#000082] hover:text-[#d32f2f] transition-colors duration-200"
            >
            ...
            <Link
              ...
              style={{ backgroundColor: '#c80000', color: '#ffffff', fontSize: '10px' }}
            >
            ...
            {isMenuOpen && (
              <>
                ...
                <motion.div
                  ...
                  style={{ borderRadius: '20px 0 0 20px', backgroundColor: '#c9d3ff' }}
                >
                  <div className="space-y-1 text-left">

                    {/* Home */}
                    <Link to="/" onClick={(e) => { closeMenu(); handleLinkClick('/', e); }}
                      className="flex items-center justify-between py-3 border-b border-white/40 text-sm font-black tracking-[0.08em] uppercase text-[#000082] hover:text-[#d32f2f] transition-colors">
                    ...
                    {/* About section */}
                    <div className="py-2 border-b border-white/40">
                      <Link to="/about" onClick={(e) => { closeMenu(); handleLinkClick('/about', e); }}
                        className="flex items-center justify-between text-sm font-black tracking-[0.08em] uppercase text-[#000082] hover:text-[#d32f2f] transition-colors pb-2">
                        <span>About</span>
                      </Link>
                      <div className="pl-3 border-l-2 border-[#000082]/20 space-y-0.5">
                  ...
                  <div className="space-y-3">
                    <div className="border-t border-white/40 pt-4 text-left">
                      <div className="text-[10px] font-mono uppercase text-[#000082]/60 tracking-wider">Direct line</div>
                      <a href="tel:+2347052940445" className="text-sm font-black text-[#000082] hover:text-[#d32f2f] transition-colors inline-block mt-0.5">
                        +234 (0) 705 294 0445
                      </a>
                    </div>
                    <Link
                      ...
                      style={{ backgroundColor: '#c80000', color: '#ffffff' }}
                    >
